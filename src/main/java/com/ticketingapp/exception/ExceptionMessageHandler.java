package com.ticketingapp.exception;

import com.ticketingapp.dto.DefaultExceptionMessageDto;
...
public class ExceptionMessageHandler {
    ...
    private Optional<DefaultExceptionMessageDto> getMessageFromAnnotation(Method method) {
        com.ticketingapp.annotation.DefaultExceptionMessage defaultExceptionMessage = method.getAnnotation(com.ticketingapp.annotation.DefaultExceptionMessage.class);
